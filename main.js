...
var $axelerator$picomponents$Pico$errorView = F3(
...
var $author$project$Form$errorView = $axelerator$picomponents$Pico$errorView($author$project$Form$errorToString);
...
var $author$project$Form$form = $axelerator$fancy_forms$FancyForms$Form$form($author$project$Form$errorView);
...
var $axelerator$fancy_forms$FancyForms$Widgets$Checkbox$checkbox = {
	...
	update: F2(
		function (_v2, model) {
			return $axelerator$fancy_forms$FancyForms$FormState$justChanged(!model);
		}),
...
var $axelerator$picomponents$Pico$invalid = A2($elm$html$Html$Attributes$attribute, 'aria-invalid', 'true');
var $axelerator$picomponents$Pico$Form$markAsInvalid = F2(
	function (errors, _v0) {
		return $elm$core$List$isEmpty(errors) ? _List_Nil : _List_fromArray(
			[$axelerator$picomponents$Pico$invalid]);
	});
var $axelerator$picomponents$Pico$role = function (kind) {
...
var $axelerator$picomponents$Pico$Form$contentWithLabel = F3(
...
var $axelerator$picomponents$Pico$Form$withLabel = F2(
	function (labelText, wrapped) {
		return A2(
			$axelerator$fancy_forms$FancyForms$Form$wrap,
			wrapped,
			$axelerator$picomponents$Pico$Form$contentWithLabel(labelText));
	});
var $axelerator$picomponents$Pico$Form$switch = function (labelText) {
	return A2(
		...
		F2(
			function (_v0, _v1) {
				return _List_fromArray(
					[
						$axelerator$picomponents$Pico$role('switch')
					]);
			}),
		A2(
			$axelerator$fancy_forms$FancyForms$FormState$withInnerAttributes,
			$axelerator$picomponents$Pico$Form$markAsInvalid,
			A2($axelerator$picomponents$Pico$Form$withLabel, labelText, $axelerator$fancy_forms$FancyForms$Widgets$Checkbox$checkbox)));
};
...
var $axelerator$picomponents$Pico$Form$textInput = function (labelText) {
	return A2(
		$axelerator$fancy_forms$FancyForms$FormState$withInnerAttributes,
		$axelerator$picomponents$Pico$Form$markAsInvalid,
		A2(
			$axelerator$picomponents$Pico$Form$withLabel,
			labelText,
...
var $author$project$Page$Login$loginForm = A3(
	...
	$axelerator$picomponents$Pico$Form$switch('Remember me'),
	A3(
		$axelerator$fancy_forms$FancyForms$Form$field,
		function ($) {
			return $.password;
		...
		A2(
			...
			A2(
				...
				$axelerator$picomponents$Pico$Form$textInput('password'))),
		A3(
			$axelerator$fancy_forms$FancyForms$Form$field,
			function ($) {
				return $.username;
			...
			A2(
				...
				_List_fromArray(
					[$axelerator$fancy_forms$FancyForms$Widgets$Text$notBlank]),
				$axelerator$picomponents$Pico$Form$textInput('username')),
			A3(
...
var $axelerator$picomponents$Pico$Theme$Dark = {$: 'Dark'};
var $axelerator$picomponents$Pico$Theme$Light = {$: 'Light'};
var $axelerator$picomponents$Pico$Theme$SystemScheme = {$: 'SystemScheme'};
var $author$project$Page$Preferences$colorSchemeVariants = _Utils_Tuple2(
	{id: 'System', label: 'System', value: $axelerator$picomponents$Pico$Theme$SystemScheme},
	_List_fromArray(
		[
			{id: 'Light', label: 'Light', value: $axelerator$picomponents$Pico$Theme$Light},
			{id: 'Dark', label: 'Dark', value: $axelerator$picomponents$Pico$Theme$Dark}
		]));
...
var $axelerator$picomponents$Pico$Form$dropdown = F2(
...
var $author$project$Page$Preferences$form = A3(
	...
	A2($axelerator$picomponents$Pico$Form$dropdown, 'Color scheme', $author$project$Page$Preferences$colorSchemeVariants),
	A3(
		$author$project$Form$form,
		$axelerator$fancy_forms$FancyForms$FormState$alwaysValid,
		'preferences-form',
...
var $author$project$Page$Preferences$init = function (session) {
	return A2($axelerator$fancy_forms$FancyForms$Form$init, $author$project$Page$Preferences$form, session.preferences);
};
...
var $author$project$Page$Signup$passwordsMustMatch = function (_v0) {
	...
	return (_Utils_eq(password, passwordConfirm) || (passwordConfirm === '')) ? _List_Nil : _List_fromArray(
		[
			$axelerator$fancy_forms$FancyForms$FormState$CustomError($author$project$Form$ConfirmationMustMatch)
		]);
};
...
var $author$project$Page$Signup$signUpForm = A3(
	...
	A2(
		...
		A2(
			...
			_List_fromArray(
				[$axelerator$fancy_forms$FancyForms$Widgets$Text$notBlank]),
			$axelerator$picomponents$Pico$Form$textInput('password confirmation'))),
	A3(
		$axelerator$fancy_forms$FancyForms$Form$field,
		function ($) {
			return $.password;
...
var $author$project$JSCommand$preferencesDecoder = A2(
	...
	A2(
		...
		function (schemeName) {
			switch (schemeName) {
				case 'light':
					return $elm$json$Json$Decode$succeed($axelerator$picomponents$Pico$Theme$Light);
				case 'dark':
					return $elm$json$Json$Decode$succeed($axelerator$picomponents$Pico$Theme$Dark);
				case 'system':
					return $elm$json$Json$Decode$succeed($axelerator$picomponents$Pico$Theme$SystemScheme);
				default:
...
var $author$project$Page$Login$rememberMeSelected = function (model) {
	return A2($axelerator$fancy_forms$FancyForms$Form$extract, $author$project$Page$Login$loginForm, model.loginFormState).rememberMe;
};
			...
			case 'ForForm':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							loginFormState: A3($axelerator$fancy_forms$FancyForms$Form$update, $author$project$Page$Login$loginForm, formMsg, model.loginFormState),
							submission: $author$project$Page$Login$WaitingForInput
						}),
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				return _Utils_Tuple2(
					...
					A3(
						...
						A2($axelerator$fancy_forms$FancyForms$Form$extract, $author$project$Page$Login$loginForm, model.loginFormState)));
			case 'LoginSuccess':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			default:
				var error = msg.a;
...
var $author$project$Page$Preferences$update = F2(
	function (msg, model) {
		var formState = A3($axelerator$fancy_forms$FancyForms$Form$update, $author$project$Page$Preferences$form, msg, model);
		return _Utils_Tuple2(
			formState,
			A2($axelerator$fancy_forms$FancyForms$Form$extract, $author$project$Page$Preferences$form, formState));
	});
			...
			case 'ForForm':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							formState: A3($axelerator$fancy_forms$FancyForms$Form$update, $author$project$Page$Signup$signUpForm, formMsg, model.formState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				var _v1 = A2($axelerator$fancy_forms$FancyForms$Form$extract, $author$project$Page$Signup$signUpForm, model.formState);
...
var $axelerator$picomponents$Pico$Centered = {$: 'Centered'};
var $phosphor_icons$phosphor_elm$Phosphor$Duotone = {$: 'Duotone'};
var $elm$html$Html$a = _VirtualDom_node('a');
var $axelerator$picomponents$Pico$elemWithClass = F3(
...
var $axelerator$picomponents$Pico$contrastLink = function (attrs) {
	return A3($axelerator$picomponents$Pico$elemWithClass, $elm$html$Html$a, 'contrast', attrs);
};
...
var $axelerator$picomponents$Pico$mkLi = function (cell) {
	return A2($elm$html$Html$li, _List_Nil, cell);
};
var $elm$html$Html$summary = _VirtualDom_node('summary');
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $axelerator$picomponents$Pico$dropdown = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$ul,
					_List_Nil,
					A2($elm$core$List$map, $axelerator$picomponents$Pico$mkLi, dropdownRows))
				]));
	});
...
var $axelerator$picomponents$Pico$secondaryLink = function (attrs) {
	return A3($axelerator$picomponents$Pico$elemWithClass, $elm$html$Html$a, 'secondary', attrs);
};
	...
	if (mbSession.$ === 'Nothing') {
		return _List_fromArray(
			[
				...
				[
					A2(
					$axelerator$picomponents$Pico$secondaryLink,
					_List_fromArray(
						[
		...
		return _List_fromArray(
			[
				...
				[
					A2(
					$axelerator$picomponents$Pico$dropdown,
					_List_fromArray(
						[
							A2(
							$phosphor_icons$phosphor_elm$Phosphor$toHtml,
					...
					_List_fromArray(
						[
							...
							[
								A2(
								$axelerator$picomponents$Pico$contrastLink,
								_List_fromArray(
									[
...
var $axelerator$picomponents$Pico$layoutClass = function (layout) {
	if (layout.$ === 'Centered') {
		return 'container';
	} else {
...
var $axelerator$picomponents$Pico$main_ = F4(
			...
			_List_fromArray(
				[
					...
					[
						...
						$axelerator$picomponents$Pico$layoutClass(layout))
					]),
					schemeClass,
					attrs
				]));
...
var $axelerator$picomponents$Pico$mkColumn = function (columns) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2(
...
var $axelerator$picomponents$Pico$nav = function (columns) {
	return A2(
		$elm$html$Html$nav,
		_List_Nil,
		A2($elm$core$List$map, $axelerator$picomponents$Pico$mkColumn, columns));
};
var $author$project$Session$preferredColorScheme = function (mbSession) {
	if (mbSession.$ === 'Nothing') {
		return $axelerator$picomponents$Pico$Theme$SystemScheme;
	} else {
	...
	function (session, content) {
		return {
			body: _List_fromArray(
				[
					A4(
					$axelerator$picomponents$Pico$main_,
					$axelerator$picomponents$Pico$Centered,
					$author$project$Session$preferredColorScheme(session),
					_List_Nil,
					A2(
						$elm$core$List$cons,
						$axelerator$picomponents$Pico$nav(
							_List_fromArray(
								[
									_List_fromArray(
									[
...
var $axelerator$picomponents$Pico$aria = F2(
	function (name, value) {
		return A2($elm$html$Html$Attributes$attribute, 'aria-' + name, value);
	});
var $axelerator$picomponents$Pico$busy = A2($elm$html$Html$Attributes$attribute, 'aria-busy', 'true');
var $elm$html$Html$Attributes$disabled = $elm$html$Html$Attributes$boolProperty('disabled');
var $elm$html$Html$fieldset = _VirtualDom_node('fieldset');
var $elm$html$Html$form = _VirtualDom_node('form');
var $elm$html$Html$div = _VirtualDom_node('div');
var $axelerator$picomponents$Pico$grid = F2(
...
var $axelerator$picomponents$Pico$primaryButton = A2($axelerator$picomponents$Pico$elemWithClass, $elm$html$Html$button, 'primary');
...
var $author$project$Page$Login$view = function (_v0) {
	...
	var submitButtonAttrs = function () {
		var _v3 = _Utils_Tuple2(
			submission,
			A2($axelerator$fancy_forms$FancyForms$Form$isValid, $author$project$Page$Login$loginForm, loginFormState));
		switch (_v3.a.$) {
			...
			case 'RequestPending':
				...
				return _List_fromArray(
					[
						$axelerator$picomponents$Pico$busy,
						$elm$html$Html$Attributes$type_('submit')
					]);
			default:
				return _List_fromArray(
	...
	var _v1 = function () {
		if (submission.$ === 'Failed') {
			...
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						A2($axelerator$picomponents$Pico$aria, 'invalid', 'true')
					]));
		} else {
			return _Utils_Tuple2(
				$elm$html$Html$text(''),
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(
				$axelerator$picomponents$Pico$grid,
				'',
				_List_fromArray(
					[
						_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									invalidAttr,
									A3($axelerator$fancy_forms$FancyForms$Form$render, $author$project$Page$Login$ForForm, $author$project$Page$Login$loginForm, loginFormState)),
									errorsView,
									A2(
									$axelerator$picomponents$Pico$primaryButton,
									submitButtonAttrs,
									_List_fromArray(
										[
											$elm$html$Html$text('Log in')
				...
				[
					...
					_List_fromArray(
						[
							...
							A3($axelerator$fancy_forms$FancyForms$Form$render, $elm$core$Basics$identity, $author$project$Page$Preferences$form, model)
						]))
				]));
	});
...
var $author$project$Page$Signup$viewForm = function (_v0) {
	...
	var submitButtonAttrs = function () {
		var _v3 = _Utils_Tuple2(
			submission,
			A2($axelerator$fancy_forms$FancyForms$Form$isValid, $author$project$Page$Signup$signUpForm, formState));
		switch (_v3.a.$) {
			case 'WaitingForInput':
				if (_v3.b) {
					var _v4 = _v3.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$fieldset,
				invalidAttr,
				A3($axelerator$fancy_forms$FancyForms$Form$render, $author$project$Page$Signup$ForForm, $author$project$Page$Signup$signUpForm, formState)),
				errorsView,
				A2(
				$axelerator$picomponents$Pico$primaryButton,
				submitButtonAttrs,
